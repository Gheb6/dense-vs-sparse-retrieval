...
\usepackage{tikz}     % Per il diagramma della pipeline
...
% =============================================================
% SLIDE 8: Results - Quality (INT8 vs FP32)
% =============================================================
\section{Results}
...
% =============================================================
% SLIDE 9: Results - Efficiency (HNSW vs Flat)
% =============================================================
\begin{frame}{Results - Efficiency (HNSW vs Flat)}
    \begin{columns}
        \column{0.5\textwidth}
        % PLACEHOLDER FOR YOUR PLOT
        % Sostituisci 'example-image' con il percorso del tuo file .pdf o .png
        % Es: \includegraphics[width=\textwidth]{results/gaming_speed_vs_quality.pdf}
